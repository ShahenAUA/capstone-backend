"""
Django settings for pet_welfare project.
...
SECRET_KEY = 'django-insecure-0o93f0x@fz-xpn$6n^!jjxb2p81o%zx*9twwz#*u40_hg4#p+s'
...
WSGI_APPLICATION = 'pet_welfare.wsgi.application'
...
SWAGGER_SETTINGS = {
    ...
    'DEFAULT_INFO': 'web_api.urls.schema_view'
}
